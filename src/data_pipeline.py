...
class DataManager(object):
    ...
    def process_photos(self):
        '''Retrieves metadata from all images in a directory
           or nested directory of photos.
        Also creates record of dataset structure; creates json file,
        ...
        print "\ndata pipeline: fetching  photo metadata,\
                creating pandas database and csv . . .\n"
...
if __name__ == '__main__':
    ...
    if len(argv) == 3:
        ImageProcessor(photo_dir=argv[1],
                        dataset_name=argv[2]).process_photos()
